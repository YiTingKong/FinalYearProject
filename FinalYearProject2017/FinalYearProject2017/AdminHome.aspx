<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdminHome.aspx.vb" Inherits="FinalYearProject2017.AdminHome" %>
...
<body class="home-style">
    ...
    <div style=" margin-top: 10px; margin-left: 490px; height: 191px; width: 365px;" class="logo-style">
        ...
        &nbsp;<asp:TextBox ID="txtpassword" runat="server" Width="140px"></asp:TextBox>
            <br />
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:ImageButton ID="ImageButton1" runat="server" src="image/button_sign-in.png"/>
        </div>
    </div>
    </form>
</body>
